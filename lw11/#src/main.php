<div class="main-content">
    ...
    <section class="content" id="animatedBlock">
        ...
        <div class="content__block">
            <img src="img/main_finances.png" class="content__image" alt="Картинка про финансы" width="538" height="476">
        ...
        <div class="content__block content__block_second">
            ...
            <img src="img/main_mind.png" class="content__image" alt="Картинка про взрыв мозга" width="504" height="691">
        </div>
    </section>
