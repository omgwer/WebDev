<div class="main-content">
    ...
    <section class="content" id="animatedBlock">
        ...
        <div class="content__block">
            <img src="img/main_finances.png" class="content__image" alt="Картинка про финансы" width="538" height="476" loading="lazy">
        ...
        <div class="content__block content__block_second">
            ...
            <img src="img/main_mind.png" class="content__image" alt="Картинка про взрыв мозга" width="504" height="691" loading="lazy">
        </div>
    </section>
    ...
    <section id="animatedBlockAdventages" class="list-advantages main__list-advantages">
        ...
        <div class="list-advantages__block">
            <img src="img/finger_one.png" alt="finger_one" loading="lazy">
            <p>Понять, что нужно делать, а что делать не стоит.</p>
        </div>
        <div class="list-advantages__block">
            <img src="img/finger_two.png" alt="finger_two" loading="lazy">
            <p>Перестать себя искусственно ограничивать.</p>
        </div>
        <div class="list-advantages__block">
            <img src="img/finger_three.png" alt="finger_three" loading="lazy">
            <p>Определить сильные стороны <br> и начать использовать слабые.</p>
        </div>
        <div class="list-advantages__block">
            <img src="img/finger_four.png" alt="finger_four" loading="lazy">
            <p>Научиться достигать любой цели <br> в 3 понятных шага.</p>
        </div>
        <div class="list-advantages__block">
            <img src="img/finger_five.png" alt="finger_five" loading="lazy">
            <p>Сотрудничать эффективно <br> и с правильными людьми.</p>
        </div>
        <div class="list-advantages__block">
            <img src="img/finger_six.png" alt="finger_six" loading="lazy">
        ...
        <div class="faq__container">
            ...
            <div class="faq__accordion">
                <button class="faq__button">
                    ...
                    <img class="faq__arrow" src="img/faq_cross.png" alt="крестик" loading="lazy">
                </button>
