...
<div class="container">
    ...
    <footer class="footer">
        <section class="footer__author">
            ...
            <img class="footer__avatar" src="img/footer_avatar.png" alt="Author photo" loading="lazy">
            ...
            <img class="footer__socials" src="img/footer_social.png" alt="Социальные сети автора" loading="lazy">
        </section>
        <div class="footer__logo-container">
            <a href="index.php">
                <img src="img/footer_logo.svg" class="footer__logo" alt="logo" loading="lazy">
            </a>
        </div>
    </footer>
    <a id="scrollToStart" class="button-scroll-to-start visually-hidden">
        <img src="img/up_button.png" alt="click this button to go to the top of the page" loading="lazy">
    </a>
    <section class="registration-form">
        <div class="overlay hidden"></div>
        <div class="popup hidden">
            <a class="popup_closed">
                <img src="img/popup-button_closed.svg" alt="press this button for close popup" loading="lazy">
            </a>
            <img class="popup__logo" src="img/popup_logo.svg" alt="popup_logo" loading="lazy">
